...
class SFX_Manager (val context: Context, var soundOn: Boolean = true) {
    ...
    init {
        ...
        sounds.put(Sound.GAME_LOST_POP_UP, soundPool.load(context, R.raw.lose_pop_up, 1))
        sounds.put(Sound.GAME_WON_POP_UP, soundPool.load(context, R.raw.win_pop_up, 1))
    }
